...
animalApp.setupEventListener = function () {
    ...
    animalApp.formSubmit.addEventListener('submit', function (event) {
        ...
        function displayPhotos(jsonData) {
            ...
            // ------------Loading Animation-------------
            // Select our .img-container (which contains our loading animation) and replace its innerHTML with an <img> element with the class of "result-image"
            document.querySelector('.img-container').innerHTML = '<img class="result-image"></img>';
            // ------------------------------------------------
            // Select our <img> element with a class of "result-image"
